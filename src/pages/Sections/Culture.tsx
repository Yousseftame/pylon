        ...
        <div className="mb-20 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="flex flex-col items-start gap-2">
             ...
             >
               ...
               <span className="text-xs font-bold tracking-[0.2em] text-white uppercase mt-1">Our Culture</span>
             </motion.div>
             <SplitText 
                text="Culture of" 
                className="text-5xl sm:text-6xl md:text-7xl font-bold tracking-tight text-white leading-[1.1]" 
                delay={40} duration={1} tag="h2" 
              />
              <SplitText 
                text="Innovation" 
          ...
          >
            We cultivate an ecosystem where multi-disciplinary experts collaborate to solve complex challenges and build the future.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[auto] md:auto-rows-[340px]">
          ...
          >
            ...
            <div className="relative z-10 h-full flex flex-col justify-between flex-grow">
              ...
              <div className="mt-auto">
                <h3 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-tight leading-[1.1]">The Ecosystem <br/><span className="text-gray-500">of Minds</span></h3>
                <p className="text-lg sm:text-xl text-gray-400 max-w-2xl leading-relaxed font-medium">
                  At Pylon Holding, our strength is our people. From civil engineers to data scientists, spatial designers to media strategists, we connect diverse brilliance to architect unprecedented solutions.
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex justify-between items-start relative z-10">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-gray-500 px-4 py-2 rounded-full border border-white/10 bg-white/5">Vision</span>
            </div>
            <div className="relative z-10 mt-auto pt-8">
               <h4 className="text-3xl font-bold text-white mb-3 tracking-tight">Future Ready</h4>
               <p className="text-gray-500 leading-relaxed font-medium">We don't just adapt to the future; we build it through continuous, systemic innovation.</p>
            </div>
          ...
          >
             <div className="relative z-10 flex justify-between items-start">
              ...
              <span className="text-xs font-bold uppercase tracking-widest text-black/60 px-4 py-2 rounded-full border border-black/10 bg-black/5">Collaboration</span>
            </div>
            <div className="relative z-10 mt-auto pt-8">
               <h4 className="text-3xl font-bold text-black mb-3 tracking-tight">Excellence</h4>
               <p className="text-black/70 leading-relaxed font-medium">A relentless pursuit of perfection across every multi-disciplinary project and initiative.</p>
            </div>
          </motion.div>
